...
public class SendWithdrawCashThread implements Callable<String> {
	...
	private final String wdpamountmsg;
	private final String wagMobNomsg;
	private final String userMobNo;
	private final String serverIpAddress;
	private boolean connected = false;

	public SendWithdrawCashThread(boolean connected, String wdpamountmsg, String wagMobNomsg, String serverIpAddress,
			String userMobNo) {
		this.wdpamountmsg = wdpamountmsg;
		this.wagMobNomsg = wagMobNomsg;
	...
	public String call() throws Exception {
		...
		try {
			...
			String safemsg = "";
			clientMsg = "mw " + wdpamountmsg + " " + wagMobNomsg;
