...
public class TicketListAdapter extends BaseAdapter {
	...
	public TicketListAdapter(Activity a, ArrayList<HashMap<String, String>> serviceList) {
		activity = a;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.ticket_list_row, null);
		...
		holder.date.setText(tempList.get("date"));
		holder.time.setText(tempList.get("time"));
