...
public class GiftcardListAdapter extends BaseAdapter {
	...
	public GiftcardListAdapter(Activity a, ArrayList<HashMap<String, String>> serviceList) {
		activity = a;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.giftcard_list_row, null);
		...
		//holder.date.setText(tempList.get("enddate"));
