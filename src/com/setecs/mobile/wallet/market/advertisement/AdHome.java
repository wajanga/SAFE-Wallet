...
public class AdHome extends TabActivity {
	...
	private Intent setupTabContent(int opt) {
		...
		switch (opt) {
		case 1:
			intent = new Intent().setClass(this, DownloadedAd.class);
			break;
		case 2:
			intent = new Intent().setClass(this, MarketAd.class);
			//intent = new Intent().setClass(this, MarketAdNew.class);
			break;
		}
		return intent;
	}
