...
public class UnPaidBills extends ListActivity implements SafeReplyHandler {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(UnPaidBills.this));

		constructGUI();

		getBillList();
		/*billList = createBillList();
		adapter = new BillRowAdapter(UnPaidBills.this, billList);
	...
	public void constructGUI() {
		...
		empty.setText(R.string.no_unpaid_bills);
	}
	...
	private ArrayList<Bill> createBillList() {
		...
		Bill bill = new Bill("1", "Internet Bill (Feb)", "70", "UNPAID");
		billList.add(bill);
		bill = new Bill("2", "Power Bill (Feb)", "170", "UNPAID");
		billList.add(bill);
		bill = new Bill("3", "Water Bill (Feb)", "200", "UNPAID");
		billList.add(bill);
		bill = new Bill("4", "Dry Cleaning Bill", "150", "UNPAID");
		billList.add(bill);
		return billList;
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		Intent i = new Intent(UnPaidBills.this, BillActivity.class);
	...
	public void in_wallet(View v) {
		Intent i = new Intent(this, PaidBills.class);
		startActivity(i);
	}
