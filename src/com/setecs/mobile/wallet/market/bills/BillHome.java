...
public class BillHome extends TabActivity {
	...
	private Intent setupTabContent(int opt) {
		...
		switch (opt) {
		case 1:
			intent = new Intent().setClass(this, PaidBills.class);
			break;
		case 2:
			intent = new Intent().setClass(this, UnPaidBills.class);
			break;
		}
		return intent;
	}
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(BillHome.this));
		...
		setupTab(new TextView(this), "Paid", 1);
		setupTab(new TextView(this), "UnPaid", 2);
