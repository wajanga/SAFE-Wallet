...
public class IntroScreenLogin extends Activity {

	public static final String WALLET_OPEN = null;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button btn = (Button) findViewById(R.id.btn_intro);
		btn.setText("Open Wallet");
	...
	public void createAccount(View v) {
		...
		intent.putExtra(WALLET_OPEN, "TRUE");
